...
VI_DEV_ATTR_S DEV_ATTR_LVDS_IMX290 =
{
    /*鎺ュ彛妯″紡*/
    VI_MODE_LVDS,
    /*1銆?銆?璺伐浣滄ā寮?/
    ...
    /*AdChnId*/
    {-1, -1, -1, -1},
    /*enDataSeq, 浠呮敮鎸乊UV鏍煎紡*/
    VI_INPUT_DATA_YUYV,

    /*鍚屾淇℃伅锛屽搴攔eg鎵嬪唽鐨勫涓嬮厤缃? --bt1120鏃跺簭鏃犳晥*/
    {
    /*port_vsync   port_vsync_neg     port_hsync        port_hsync_neg        */
    //VI_VSYNC_PULSE, VI_VSYNC_NEG_HIGH, VI_HSYNC_VALID_SINGNAL,VI_HSYNC_NEG_HIGH,VI_VSYNC_NORM_PULSE,VI_VSYNC_VALID_NEG_HIGH,
     //VI_VSYNC_PULSE, VI_VSYNC_NEG_HIGH, VI_HSYNC_VALID_SINGNAL, VI_HSYNC_NEG_HIGH, VI_VSYNC_VALID_SINGAL, VI_VSYNC_VALID_NEG_HIGH,
...
// 10lane 30fps
combo_dev_attr_t LVDS_10lane_SENSOR_IMX290_10BIT_2M_2WDR1_ATTR =
{
    .devno         = 0,
    .input_mode    = INPUT_MODE_LVDS,      /* input mode */
    .phy_clk_share = PHY_CLK_SHARE_NONE,
...
// 10lane 30fps
combo_dev_attr_t LVDS_10lane_SENSOR_IMX290_10BIT_2M_LINE_ATTR =
{
    .devno         = 0,
    .input_mode    = INPUT_MODE_LVDS,      /* input mode */
    .phy_clk_share = PHY_CLK_SHARE_NONE,
...
combo_dev_attr_t MIPI_4lane_SENSOR_IMX385_12BIT_ATTR =
{
    .devno         = 0,
    .input_mode    = INPUT_MODE_MIPI,
    .phy_clk_share = PHY_CLK_SHARE_PHY0,
    .img_rect = {4, 0, 1920, 1080},
    .mipi_attr =
    {
        .raw_data_type = RAW_DATA_12BIT,
        .wdr_mode      = HI_WDR_MODE_NONE,
...
combo_dev_attr_t MIPI_4lane_SENSOR_IMX385_1080P_12BIT_NOWDR_ATTR =
{
	.devno		   = 0,
	.input_mode    = INPUT_MODE_MIPI,	   /* input mode */
	.phy_clk_share = PHY_CLK_SHARE_NONE,
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_VI_MODE_E enViMode, VI_DEV_ATTR_S *pstViDevAttr)
{
    ...
    case SONY_IMX290_LVDS_2K_30FPS:
        ...
        stViDevAttr.stBasAttr.stSacleAttr.bCompress = HI_FALSE;
        break;
    case SONY_IMX385_MIPI_2K_30FPS:
        memcpy(&stViDevAttr, &DEV_ATTR_MIPI_BASE, sizeof(stViDevAttr));
        stViDevAttr.stDevRect.s32X = 0;
        stViDevAttr.stDevRect.s32Y = 0;
        stViDevAttr.stDevRect.u32Width  = 1920;
...
HI_S32 SAMPLE_COMM_VI_SetMipiAttr(COMBO_DEV MipiDev, SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    else if (pstViConfig->enViMode == SONY_IMX290_LVDS_2K_30FPS)
    {
        if (WDR_MODE_2To1_LINE == pstViConfig->enWDRMode)
        {
            pstcomboDevAttr = &LVDS_10lane_SENSOR_IMX290_10BIT_2M_2WDR1_ATTR;
        }
        else
        {
            pstcomboDevAttr = &LVDS_10lane_SENSOR_IMX290_10BIT_2M_LINE_ATTR;
        }
    }
    else if (pstViConfig->enViMode == SONY_IMX385_MIPI_2K_30FPS)
    {
        if (WDR_MODE_2To1_LINE == pstViConfig->enWDRMode)
        {
            pstcomboDevAttr = &MIPI_4lane_SENSOR_IMX385_12BIT_ATTR;
        }
        else
        {
            pstcomboDevAttr = &MIPI_4lane_SENSOR_IMX385_12BIT_ATTR;
	...
	printf("input_mode = %d enViMode = %d\n",stcomboDevAttr.input_mode,pstViConfig->enViMode);
    /* 1.reset mipi */
...
/*
	...
	system("himm 0x12040180 1");
	system("himm 0x1204c400 2");
	system("himm 0x1204c008 0");
	
	usleep(50000);
	system("himm 0x1204c008 0xff");
	...
	*/
	...
	VI_WDR_ATTR_S stWDRAttr;
	stWDRAttr.bCompress = HI_FALSE;
	HI_MPI_VI_SetWDRAttr(0, &stWDRAttr);
...
HI_S32 SAMPLE_COMM_VI_StartIspAndVi(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    ******************************************/
    for (i = 0; i < u32DevNum; i++)
    {
		...
		//HI_MPI_ISP_GetWDRExposureAttr(ISP_DEV IspDev, ISP_WDR_EXPOSURE_ATTR_S * pstWDRExpAttr)
	...
	HI_MPI_ISP_SetWDRMode(IspDev, &stWdrMode);
*/
