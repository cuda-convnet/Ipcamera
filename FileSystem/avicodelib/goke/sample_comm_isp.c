...
#elif defined(SNS_IMX385_MIPI_SINGLE)
...
static HI_S32 GetIspPubAttrBySns(ISP_PUB_ATTR_S *pstPubAttr)
{
    ...
    case SONY_IMX290_LVDS_2K_30FPS:
        stPubAttr.enBayer				= BAYER_GBRG;//BAYER_RGGB
        stPubAttr.f32FrameRate          = 30;
        stPubAttr.stWndRect.s32X        = 0;
        stPubAttr.stWndRect.s32Y        = 0;
        stPubAttr.stWndRect.u32Width    = 1920;
    ...
    case SONY_IMX385_MIPI_2K_30FPS:
        stPubAttr.enBayer				= BAYER_RGGB;//BAYER_RGGB
        stPubAttr.f32FrameRate          = 30;
        stPubAttr.stWndRect.s32X        = 0;
        stPubAttr.stWndRect.s32Y        = 0;
        stPubAttr.stWndRect.u32Width    = 1920;
