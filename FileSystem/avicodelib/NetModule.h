...
#define NET_PROCESS_TO_SYS_SOCKET (22326)

#define MN_MAX_BUF_SIZE (512*1024)

#define MN_MAX_BIND_ENC_NUM (2)
...
int old_dec_chan;
int send_data_flag;
int is_yb_nvr;    // is_yb_nvr = 1  stand for connect by yb nvr. is_yb_nvr = 0 stand for connect by CMS.
...
int net_lost_frame[MN_MAX_BIND_ENC_NUM];
pthread_mutex_t control_mutex;
int is_onvif_connect;
int is_check_goke_recv_data_num;
int key_frame_lost_num;
}NET_MODULE_ST;
